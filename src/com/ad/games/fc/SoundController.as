...
{
	import com.ad.games.fc.model.ship.equipment.BoilersRoomHullSection;
	...
	public final class SoundController
	{
		...
		public static function cannonFirePrimary():void {
			if (isSoundEnabled && ((new Date()).getTime() - lastCannonFireTime) > CANNON_FIRE_SOUND_DELAY && cannonFireSoundsCount < CANNON_FIRE_SOUND_LIMIT) {
				lastCannonFireTime = (new Date()).getTime();
